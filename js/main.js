...
function applyI18n(){
  ...
  document.querySelector('[data-i="hero-title"]').textContent = d.hero_title;
  document.querySelector('[data-i="hero-sub"]').textContent = d.hero_sub;
  document.querySelector('[data-i="kpi1"]').textContent = d.kpi1;
  document.querySelector('[data-i="kpi2"]').textContent = d.kpi2;
  document.querySelector('[data-i="kpi3"]').textContent = d.kpi3;
  document.querySelector('[data-i="why-title"]').textContent = d.why_title;
  document.querySelectorAll('[data-i="why-card-title"]').forEach((el,i)=> el.textContent = d.why_cards[i][0]);
  document.querySelectorAll('[data-i="why-card-text"]').forEach((el,i)=> el.textContent = d.why_cards[i][1]);
  document.querySelector('[data-i="process-title"]').textContent = d.process_title;
  document.querySelectorAll('[data-i="step-title"]').forEach((el,i)=> el.textContent = d.steps[i][0]);
  document.querySelectorAll('[data-i="step-text"]').forEach((el,i)=> el.textContent = d.steps[i][1]);
  document.querySelector('[data-i="research-title"]').textContent = d.research_title;
  document.querySelector('[data-i="research-lead"]').textContent = d.research_lead;
  document.querySelectorAll('[data-i="research-point"]').forEach((el,i)=> el.textContent = d.research_points[i]);
  document.querySelector('[data-i="pricing-title"]').textContent = d.pricing_title;
  document.querySelectorAll('[data-i="pkg-title"]').forEach((el,i)=> el.textContent = d.pkg[i][0]);
  document.querySelectorAll('[data-i="pkg-sub"]').forEach((el,i)=> el.textContent = d.pkg[i][1]);
  document.querySelectorAll('[data-i="pkg-features"]').forEach((el,i)=> el.textContent = d.pkg[i][2]);
  document.querySelectorAll('[data-i="pkg-cta"]').forEach((el,i)=> el.textContent = d.pkg[i][3]);
  document.querySelector('[data-i="est-title"]').textContent = d.est_title;
  document.querySelector('[data-i="label-bill"]').textContent = d.est_label_bill;
  document.querySelector('[data-i="label-acs"]').textContent = d.est_label_acs;
  document.querySelector('[data-i="label-timer"]').textContent = d.est_label_timer;
  document.querySelector('[data-i="est-btn"]').textContent = d.est_btn;
  document.querySelector('[data-i="est-note"]').textContent = d.est_note;
  document.querySelector('[data-i="faq-title"]').textContent = d.faq_title;
  document.querySelectorAll('[data-i="faq-q"]').forEach((el,i)=> el.textContent = d.faq[i][0]);
  document.querySelectorAll('[data-i="faq-a"]').forEach((el,i)=> el.textContent = d.faq[i][1]);
  document.querySelector('[data-i="contact-title"]').textContent = d.contact_title;
  document.querySelector('[data-i="form-name"]').textContent = d.form.name;
  document.querySelector('[data-i="form-city"]').textContent = d.form.city;
  document.querySelector('[data-i="form-email"]').textContent = d.form.email;
  document.querySelector('[data-i="form-phone"]').textContent = d.form.phone;
  document.querySelector('[data-i="form-bill"]').textContent = d.form.bill;
  document.querySelector('[data-i="form-acs"]').textContent = d.form.acs;
  document.querySelector('[data-i="form-msg"]').textContent = d.form.msg;
  document.querySelector('[data-i="form-submit"]').value = d.form.submit;
  document.querySelector('[data-i="form-help"]').textContent = d.form.help;
  document.querySelector('[data-i="footer"]').textContent = d.footer;
  ...
  document.getElementById('chart-uncertainty').src = 'assets/' + (currentLang === 'ar' ? 'chart_biggest_uncertainty_ar.png':'chart_biggest_uncertainty_en.png');
  document.getElementById('chart-solution').src = 'assets/' + (currentLang === 'ar' ? 'chart_solution_pref_ar.png':'chart_solution_pref_en.png');
  document.getElementById('chart-bills').src = 'assets/' + (currentLang === 'ar' ? 'chart_bill_sensitivity_ar.png':'chart_bill_sensitivity_en.png');
  document.getElementById('chart-heater').src = 'assets/' + (currentLang === 'ar' ? 'chart_heater_timers_ar.png':'chart_heater_timers_en.png');
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Savings estimator
  document.getElementById('estimate-btn').addEventListener('click', (e)=>{
    e.preventDefault();
